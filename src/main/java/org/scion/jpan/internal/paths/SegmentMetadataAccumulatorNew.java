...
class SegmentMetadataAccumulatorNew {

  private SegmentMetadataAccumulatorNew() {}

  static void writeStaticInfoMetadata(
      PathMetadata.Builder path,
      SegmentsNew.PathSegment[] pathSegments,
      SegmentsNew.Range[] ranges) {
    ...
    for (int r = 0; r < ranges.length; r++) {
      SegmentsNew.Range range = ranges[r];
