...
/**
 * Same as PingPongChannelServer but uses a Selector. It can be used with the
 * ScionPingPongChannelClient.
 */
public class ScionPingPongSelectorServer {

  //  static class ScionSelector extends AbstractSelector {
  //
  //    ScionSelector() {
  //      // TODO
  ...
  //  }
  //
  //  public static void sendMessage(DatagramChannel channel, String msg, SocketAddress
  // serverAddress)
  //      throws IOException {
  ...
  //            System.out.println("Received from client at: " + remoteAddress + "  message: " +
  // message);
  //
