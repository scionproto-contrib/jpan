...
public class PolicyTest {
  ...
  //                                    {Action: Deny, Rule: mustHopPredicate(t,
  // "1-ff00:0:111#2823")},
  //                                    allowEntry,
  //                                },
  //                            },
  ...
  void TestFilterOpt() {
    ...
    PplPolicy policy =
        PplPolicy.create(
            ...
            PplPolicy.Option.create(
                0,
                PplPolicy.ExtPolicy.createExt(
                    null, null, Sequence.create("0+ 1-ff00:0:111 0+"), null)));
    List<Path> outPaths = policy.filterOpt(paths, PplPolicy.FilterOptions.create(true));
    // TODO assertEquals(3, outPaths.size());
    ...
    // "sequence is ignored":
    // TODO policy = PplPolicy.create("", null, newSequence("0+ 1-ff00:0:111 0+"), null);
    // TODO outPaths = policy.filterOpt(paths, PplPolicy.FilterOptions.create(true));
    // TODO assertEquals(3, outPaths.size());
