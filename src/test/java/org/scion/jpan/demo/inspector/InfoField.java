...
public class InfoField {
  ...
  public void write(ByteBuffer data) {
    int i0 = 0;
    i0 = ByteUtil.writeInt(i0, 0, 6, 0);
    i0 = ByteUtil.writeBool(i0, 6, p);
    i0 = ByteUtil.writeBool(i0, 7, c);
    i0 = ByteUtil.writeInt(i0, 8, 8, 0); // RSV
    i0 = ByteUtil.writeInt(i0, 16, 16, segID);
    data.putInt(i0);
