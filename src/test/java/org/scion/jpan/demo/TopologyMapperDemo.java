...
public class TopologyMapperDemo {
  ...
  public static void main(String[] args) throws IOException {
    switch (NETWORK) {
      ...
      case SCION_PROTO:
        {
          // ./bazel-bin/scion/cmd/scion/scion_/scion showpaths 2-ff00:0:222 --sciond
          // 127.0.0.100:30255
          ...
          //          //System.setProperty(Constants.PROPERTY_DAEMON,
          // "[fd00:f00d:cafe::7f00:33]:31060"); // 0;132
  ...
  private static class AsLink {
    ...
    public AsLink(long isdAs0, long isdAs1, long id0, long id1) {
      if (isdAs0 < isdAs1) {
        this.as0 = isdAs0;
        this.as1 = isdAs1;
        this.id0 = id0;
  ...
  private static void write(Map<Long, AsInfo> asMap, Set<AsLink> asLinks) throws IOException {
    ...
    String issuer = "1-ff00:0:210";
    for (AsInfo as : asMap.values()) {
      if (issuingMap.contains(as.isdAs)) {
        issuer = ScionUtil.toStringIA(as.isdAs);
        break;
      }
    }
    ...
    for (AsInfo as : asMap.values()) {
      ...
      if (issuingMap.contains(as.isdAs)) {
        ...
        writer.append("    cert_issuer: ").append(issuer).append(NL); // TODO
      }
    }
